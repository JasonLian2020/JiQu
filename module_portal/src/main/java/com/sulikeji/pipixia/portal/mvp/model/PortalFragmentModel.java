 ...
 */
@FragmentScope
public class PortalFragmentModel extends BaseModel implements PortalVideoContract.Model, PortalImageContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PortalFragmentModel(IRepositoryManager repositoryManager) {
