 ...
 */
@Module
public abstract class PortalImageModule {

    @Binds
    abstract PortalImageContract.Model bindPortalModel(PortalFragmentModel model);
    ...
    @FragmentScope
    @Provides
    static BaseQuickAdapter providePortalCommentAdapter(PortalImageContract.View view, List<FeedListBean> commentList) {
