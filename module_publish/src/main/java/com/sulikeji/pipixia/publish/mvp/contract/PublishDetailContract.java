package com.sulikeji.pipixia.publish.mvp.contract;
...
public interface PublishDetailContract {
    ...
    interface View extends IView {
        ...
        List<MediaBean> getSelectedList();

        boolean isFromImage();

        boolean isFromVideo();

        void updateChooseImage();

        String getJsonTextContent();
    ...
    interface Model extends IModel {
        ...
        Observable<PublicBaseResponse> postPublishMessage(PublishPostBean detailBean);
    }
}
