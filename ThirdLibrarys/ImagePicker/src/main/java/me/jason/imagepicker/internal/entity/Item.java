...
public class Item implements Parcelable {
    ...
    private Item(long id, String mimeType, long size, long duration, long width, long height) {
        this.id = id;
    ...
    //拍照/录制视频之后获取的
    private Item(String mimeType, Uri contentUri) {
        this.id = ITEM_ID_CAPTURE;
        this.mimeType = mimeType;
        this.uri = contentUri;
        this.size = 0;
        this.duration = 0;
    ...
    public static Item valueOf(String mimeType, Uri contentUri) {
        return new Item(mimeType, contentUri);
    }
